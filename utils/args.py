...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--weight_path', default='./ckpt/slu_tagging.pth', help='path of model weight')
    arg_parser.add_argument('--dataroot', default='./data', help='root of data')
    arg_parser.add_argument('--word2vec_path', default='./model/word2vec_768.txt', help='path of word2vector file path')
    ...
    # model
    arg_parser.add_argument('--encoder_cell', default='LSTM', choices=['RNN', 'LSTM', 'GRU',], help='root of data')
