...
def add_argument_base(arg_parser):
    # general
    arg_parser.add_argument('--model', default='slu_tagging', choices=args_choices['model'], help='model name')
    ...
    # model
    arg_parser.add_argument('--bert_version', default='hfl/chinese-bert-wwm-ext', help='path of pretrained bert')
    arg_parser.add_argument('--warmup_epoch', default=5, help='encoder type')
    arg_parser.add_argument('--encoder_cell', default=None, choices=args_choices['encoder_cell'], help='type of encoder cell')
